...
class TitleState extends MusicBeatState
{
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			{
				case 1:
					createCoolText(['Rom4chek', 'Samko115', 'JulianGaming', 'Slave under my bed']);
				// credTextShit.visible = true;
				case 3:
					addMoreText('created this shit');
				// credTextShit.text += '\npresent...';
				...
				// credTextShit.text += '\nNight';
				case 15:
					addMoreText('Cringe Edition'); // credTextShit.text += '\nFunkin';
