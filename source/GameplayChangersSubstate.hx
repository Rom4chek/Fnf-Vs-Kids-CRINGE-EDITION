...
class GameplayChangersSubstate extends MusicBeatSubstate
{
	...
	function getOptions()
	{
		var option:GameplayOption = new GameplayOption('NOTES SONIC SPEED', 'scrollspeed', 'float', 1);
		...
		var option:GameplayOption = new GameplayOption('Health steal Multiplier', 'healthgain', 'float', 1);
		...
		var option:GameplayOption = new GameplayOption('Health Fuck Multiplier', 'healthloss', 'float', 1);
		option.scrollSpeed = 2.5;
		option.minValue = 0.5;
		option.maxValue = 5;
		option.changeValue = 0.1;
		...
		var option:GameplayOption = new GameplayOption('Pussy Mode', 'practice', 'bool', false);
		optionsArray.push(option);

		var option:GameplayOption = new GameplayOption('Skill issue mode', 'botplay', 'bool', false);
		optionsArray.push(option);
	}
