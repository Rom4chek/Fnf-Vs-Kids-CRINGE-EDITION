...
class Note extends FlxSprite
{
	...
	public var gfAltNote:Bool = false;
	public var shitNote:Bool = false;
	public var tallNote:Bool = false;
	public var fatNote:Bool = false;
	public var drainNote:Bool = false;
	public var drainNoteshakeless:Bool = false;
	...
	private function set_noteType(value:String):String {
		...
		if(noteData > -1 && noteType != value) {
			switch(value) {
				...
				case 'Dodge Note':
					reloadNote('BOOM');
					noteSplashTexture = 'BOOMnoteSplashes';
					colorSwap.hue = 0;
					colorSwap.saturation = 0;
					colorSwap.brightness = 0;
				case 'Dodge Sussy Note':
					reloadNote('BOOM');
					noteSplashTexture = 'BOOMnoteSplashes';
					colorSwap.hue = 0;
					colorSwap.saturation = 0;
				...
				case 'Drain Note':
					...
					colorSwap.brightness = 0;
					drainNote = true;
					case 'Drain Note no shake':
						reloadNote('HURT');
						colorSwap.hue = 0;
						colorSwap.saturation = 0;
						colorSwap.brightness = 0;
						drainNoteshakeless = true;
					case 'Shit Note':
						reloadNote('GREE');
						colorSwap.hue = 0;
						colorSwap.saturation = 0;
	...
	override function update(elapsed:Float)
		{
			...
			if (mustPress)
			{
				...
				if (strumTime < Conductor.songPosition - (hitCausesMiss ? Conductor.safeZoneOffsetHURTNOTE:Conductor.safeZoneOffset) && !wasGoodHit)
					tooLate = true;
			}
			else
			{
