...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["Triple Trouble",		"Beat Week Cringe.",				'week1_beat',			false],
		["Nice View",		"Beat \"Ommetaphobia\" song.",				'beat_ommeta',			false],
		["100 is my fav number",		"Beat Week Cringe on Hard with no 100 Misses.",				'100',			false],
		["better than GOD",		"Beat \"Ommetaphobia\" song with no Misses.",				'ommetaphob_fc',			false],
		["WTF HOW DID U FC THIS ALL SHIT",		"can u FC the week Cringe???",				'week1_nomiss',			false],
		["i don't like movement",		"miss 100 times the \"DODGE\" note",				'dodge',			false],
		["Freaky on a Friday Night",	"Play on a Friday... Night.",						'week7_nomiss',	 true],
		["Skill issue lol",	"Complete a Song with a rating lower than 20%.",	'ur_bad',				false],
		["Impossible",				"Complete a Song with a rating of 100%.",			'ur_good',				false],
		["Freaky on a Friday Night",	"Play on a Friday... Night.",						'week7_nomiss',	 true],
		["Beep Baap Bruuh",		"Hold down a note for 10 seconds.",					'oversinging',			false],
		["Hyperactive",					"Finish a Song without going Idle.",				'hype',					false],
		["Good luck on this",			"Finish a Song pressing only two keys.",			'two_keys',				false],
		["Low Pc Gamer",				"Have you tried to run the game on a toaster?",		'toastie',				false],
		["Debugger",					"Beat the \"Test\" Stage from the Chart Editor.",	'debugger',				 true]
	];
	public static var achievementsMap:Map<String, Bool> = new Map<String, Bool>();

	public static var henchmenDeath:Int = 0;
	public static var dodgeMiss:Int = 0;
	...
	public static function loadAchievements():Void {
		if(FlxG.save.data != null) {
			...
			if(dodgeMiss == 0 && FlxG.save.data.dodgeMiss != null) {
				dodgeMiss = FlxG.save.data.dodgeMiss;
			}
		}
